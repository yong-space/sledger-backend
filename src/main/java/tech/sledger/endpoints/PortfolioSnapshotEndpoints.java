...
public class PortfolioSnapshotEndpoints {
    ...
    private EmailSnapshot buildSnapshotData() {
        ...
        positions.sort((a, b) -> b.getDailyPnl().compareTo(a.getDailyPnl()));
        ...
        BigDecimal dayPnlPercent = dayPnl.multiply(BigDecimal.valueOf(100)).divide(mktValue.subtract(dayPnl), RoundingMode.HALF_EVEN);
        BigDecimal netPnlPercent = netPnl.multiply(BigDecimal.valueOf(100)).divide(mktValue.subtract(netPnl), RoundingMode.HALF_EVEN);
